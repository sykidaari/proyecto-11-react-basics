  ...
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        cN(
          // base-classes
          'block font-app-titles text-2xl  bg-radial to-150%  border-2 rounded-md px-3 py-0.5 scale-100 hover:scale-110 transition  border-app-teal-500 from-app-teal-100 to-app-teal-400 text-app-gold-800',
